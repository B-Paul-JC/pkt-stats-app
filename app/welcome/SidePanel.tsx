...
export const SidePanel = () => {
  return (
    <section className="p-8 col-start-1 grid lg:grid-cols-12 lg:grid-rows-6 justify-center items-center col-span-1 h-1/2 row-span-1 lg:h-full">
      <section className="bg-white shadow-lg rounded-lg col-span-12 lg:row-span-2  lg:row-start-3 lg:h-full grid gap-6 lg:gap-4 items-center justify-items-start lg:grid-rows-3 grid-cols-1 p-10 pop-in-animation">
