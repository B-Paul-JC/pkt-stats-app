...
export const SidePanel = () => {
  return (
    <section className="p-8 col-start-1 grid lg:grid-cols-12 lg:grid-rows-6 justify-center items-center col-span-1 h-1/2 row-span-1 lg:h-full">
      <section className="bg-white shadow-lg rounded-lg col-span-12 lg:row-span-4 lg:row-start-2 lg:h-full grid gap-6 lg:gap-4 items-center justify-items-start lg:grid-rows-3 grid-cols-1 p-10 pop-in-animation">
        <h2 className="font-bold row-span-2 flex items-center">
          <img src={logo} className="w-8 h-10 lg:w-30 lg:h-35" alt="" />
          <span className="p-2 text-sm lg:text-4xl lg:p-9">
